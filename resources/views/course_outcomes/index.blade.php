...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        {{ Breadcrumbs::render('course_outcomes.index') }}
        <div class="pb-8">
                    ...
                    @foreach ($courses as $course)
                        <div class="card bg-base-100 shadow-xl mb-5"
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('course_outcomes.add_outcomes',$course->id) }}" method="get">
                                        <button class="pr-10" type="submit"><strong>Add Outcomes</strong></button>
                                    </form>
                                    <form action="{{ route('course_outcomes.map_outcomes',$course->id) }}" method="get">
                                        <button class="pr-10 text-green-700" type="submit"><strong>Map Outcomes</strong></button>
                                    </form>
                                    <form action="{{ route('course_outcomes.course_assessments',$course->id) }}" method="get">
                                        <button class="pr-10 text-blue-400" type="submit"><strong>Select Course Assesments</strong></button>
                                    </form>
                                    <form action="{{ route('course_outcomes.question_outcome',$course->id) }}" method="get">
                                        <button class="pr-10 text-gray-400" type="submit"><strong>Assign Question Marks</strong></button>
                                    </form>
                                    <form action="{{ route('course_outcomes.student_marks',$course->id) }}" method="get">
                                        <button class="pr-10 text-green-500" type="submit"><strong>Assign Student Marks</strong></button>
                                    </form>
                                </div>                                
                            </div>
                        </div>
