                    ...
                    success: function (response) {
                        $.each(students, function (studentIndex, student) {
                            ...
                            $.each(assessmentDetails, function (index, detail) {
                                ...
                                inputField = '<td class="marks_division" data-id="' + (existingMark.length > 0 ? existingMark[0].id : -1) + '" data-assessment_detail_id="' + detail.id + '" data-student_id="' + student.id + '" class="border-b border-gray-100 px-6 py-3 text-gray-500 font-medium tracking-wide uppercase text-xs truncate">' +
