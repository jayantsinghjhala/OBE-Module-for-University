...
<head>
    ...
    <title>SPSU-OBE | Outcome Based Education</title>
...
<div class="h-full">
    <!--Nav-->
    <div class="w-full container mx-auto shadow p-3 mb-5 bg-white rounded">
        <div class="w-full flex items-center justify-between">
            <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
               href="{{ route('welcome') }}">
                ...
                SPSU-<span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500">OBE</span>
            </a>
    ...
    <!--Main-->
    <div class="container pt-20 md:pt-24 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <!--Left Col-->
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            <h1 class="my-4 text-3xl md:text-5xl text-black-50 opacity-75 font-bold leading-tight text-center md:text-left">
                Welcome to <span class="text-indigo-400"><p>SPSU-OBE.</p></span>
            </h1>
            <p class="leading-normal text-gray-400 text-base md:text-2xl mb-8 text-center md:text-left">
                SPSU-OBE is an application for managing the student's grades based on Outcome-Based Education (OBE) grading system.
            </p>
        ...
        <div class="w-full xl:w-3/5 p-12 overflow-hidden">
            <img
                ...
                src="{{ asset('asset/images/building_2.png') }}">
        </div>
