        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form method="POST" action="{{ route('syllabi.update',$syllabus) }}">
                    ...
                    <div class="form-control w-full p-3">
                        <label class="label">
                            <span class="label-text">Head of Program</span>
                        </label>
                        <input type="text" name="head_of_program" placeholder="Head of Program"
                               class="input input-bordered w-full max-w-xs" value="{{ old('head_of_program', $syllabus->head_of_program) }}"/>
                        <x-input-error :messages="$errors->get('head_of_program')" class="mt-2"/>
                    </div>
