        ...
        <div
            ...
            @can('is-admin')
                    ...
                    <div class="bg-slate-300 text-accent-content rounded-box p-4 shadow-xl">
                        <div class="flex items-center">
                            <div class="flex-1 px-2">
                                ...
                                <p class="text-sm text-opacity-80">Faculties</p>
                            </div>
                            <div class="flex-0">
                        ...
                        <div class="flex-1 px-2 pt-4">
                            ...
                            <p class="text-sm text-opacity-80">Departments</p>
                        </div>
                        <div class="flex-1 px-2 pt-4">
                            <h2 class="text-3xl font-extrabold">{{ $ProgramsCount }}</h2>
                            <p class="text-sm text-opacity-80">Programs</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                            ...
                            <ul class="menu overflow-visible p-0">
                                @if(!empty($departments))
                                    @foreach($departments as $department)
                                        <li>
                                            <a href="{{ route('courses.show', $department) }}">
                                                {{ $department->name }}
                                            </a>
                                        </li>
                                    @endforeach
                    ...
                    <a href="{{ route('departments.index') }}" class="btn btn-secondary btn-block space-x-2">
                            ...
                            <ul class="menu overflow-visible p-0">
                                @if(!empty($programs))
                                    @foreach($programs as $program)
                                        <li>
                                            <a href="{{ route('courses.show', $program) }}">
                                                {{ $program->name }}
                                            </a>
                                        </li>
                                    @endforeach
                                @else
                                    <li class="p-3 text-red-400">
                                        No Program have been created yet
                                    </li>
                                @endif
                            </ul>
                        </div>
                    </div>
                    <a href="{{ route('programs.index') }}" class="btn btn-secondary btn-block space-x-2">
                        <span>More details</span>
                    </a>
                </div>
                ...
                <div
                            ...
                            <ul class="menu overflow-visible p-0">
                                @if(!empty($faculties))
                                    @foreach($faculties as $faculty)
                                        <li>
                                            <a href="{{ route('courses.show', $faculty) }}">
                                                {{ $faculty->name }}
                                            </a>
                                        </li>
                                    @endforeach
                    ...
                    <a href="{{ route('users.index') }}" class="btn btn-secondary btn-block space-x-2">
                        <span>More details</span>
                    </a>
                </div>
